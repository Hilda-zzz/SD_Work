...
RaycastResult2D RaycastVsAABB2D(Vec2 const& startPos, Vec2 const& fwdNormal, float maxDist,
	AABB2 const& box);
...
RaycastResult3D RaycastVsAABB3D(Vec3 const& startPos, Vec3 const& fwdNormal, float maxDist,
	AABB3 const& box);
RaycastResult3D RaycastVsZCylinder3D(Vec3 const& startPos, Vec3 const& fwdNormal, float maxDist,
	Vec3 const& cylinderCenter, float cylinderRadius, float halfHeight);
RaycastResult3D RaycastVsPlane3(Vec3 const& startPos, Vec3 const& fwdNormal, float maxDist,
	Plane3 const& plane);
RaycastResult3D RaycastVsOBB3(Vec3 const& startPos, Vec3 const& fwdNormal, float maxDist,
	OBB3 const& box);
