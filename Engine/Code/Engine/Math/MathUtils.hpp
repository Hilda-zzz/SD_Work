...
//-----------------------------------------------------------------------------------------------
// Bounce / Physics Response (2D)
//-----------------------------------------------------------------------------------------------
void		BounceDiscOffPoint(Vec2 const& point, Vec2 const& discCenter, Vec2& discVelocity, float discRadius, float elasticity);
void		BounceDiscOffStaticDisc2D(Vec2 const& bumperCenter, float bumperRadius, Vec2& discCenter, Vec2& discVelocity, float discRadius, float elastcityBumper, float elastcityBall);
void		BounceDiscOffCapsule2D(Capsule2 const& bumper, Vec2& discCenter, float discRadius, Vec2& discVelocity, float elastcityBumper, float elastcityBall);
void		BounceDiscOffOBB2D(OBB2 const& bumper, Vec2& discCenter, float discRadius, Vec2& discVelocity, float elastcityBumper, float elastcityBall);
void		BounceDiscOffEachOther(Vec2& aCenter, float aRadius, Vec2& aVelocity, float aElasticity, Vec2& bCenter, float bRadius, Vec2& bVelocity, float bElasticity);
...
//-----------------------------------------------------------------------------------------------
// Matrix & Billboard Utilities
//-----------------------------------------------------------------------------------------------
Mat44		GetLookAtMatrix(const Vec3& pos, const Vec3& target);
Mat44		GetBillboardMatrix(BillboardType billboardType, Mat44 const& targetMatrix, Vec3 const& targetPos, const Vec3& billboardPosition, const Vec2& billboardScale = Vec2(1.f, 1.f));
