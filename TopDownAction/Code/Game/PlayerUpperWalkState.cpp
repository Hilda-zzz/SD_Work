#include "PlayerUpperWalkState.hpp"

PlayerUpperWalkState::PlayerUpperWalkState(SpriteAnimDefinition* anim) : AnimState("UpperWalk", anim)
{
}

int  PlayerUpperWalkState::Update(float deltaTime, const std::unordered_map<std::string, bool>& conditions)
{
