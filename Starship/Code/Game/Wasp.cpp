...
Wasp::Wasp(Game* game, float x, float y) : Entity(game, x, y)
{
	...
	vertices[5] = Vertex_PCU(Vec3(0.f, -1.1f, 0.f), Rgba8(255, 255, 0, 255), Vec2(0.f, 0.f));
}
...
void Wasp::Die()
{
	m_game->GenerateDebris(m_position, Rgba8(255, 255, 0, 130), 
		8, 15.f, 35.f, 1.5f, 2.f, m_velocity);
	m_isGarbage = true;
}

void Wasp::GetHurt(float hurtPoint)
{
	m_health -= hurtPoint;
